...
_Keep scope tight for the first pass: e.g., Brand Search, Retargeting, CTV/YouTube Prospecting._
...
_This pass creates incrementality-adjusted KPIs your teams will use daily: adjusted conversions/revenue, iROAS, and incremental CAC._
