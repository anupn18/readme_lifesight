...
metadata:
  title: Setup Guide ChatGPT
  description: Connect Lifesight MCP to ChatGPT Codex in 2 minutes.
  keywords:
    - Setup Guide ChatGPT
  robots: index
---
...
1. An active Lifesight workspace. If you're evaluating Lifesight,<Anchor target="_blank" href="https://lifesight.io/demo/"> book a demo</Anchor>.
...
2. **Add the MCP Server in ChatGPT Codex**
   ...
   - Fill in Bearer Token MCP_BEARER_TOKEN


     <Image src="https://files.readme.io/83a5cf2fac4e344a6148eb2be1db33d467031f820a0d4921c0892830e77c40ed-Screenshot_2026-06-01_at_10.16.26_PM.png" align="left" width="500px" border={true} wrap={true} />
