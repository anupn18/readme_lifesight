...
3. **Incremental Revenue**:\
   By multiplying iROAS and pROAS, we get a measure of the true incremental revenue generated by the marketing activity. This accounts for both the platform's detailed attribution data and the broader market dynamics captured by MMM.
...
Social Media:
  iROAS: 1.2, pROAS: 2.0
  Incremental Revenue = 1.2 * $100,000 = $120,000

Search:
  iROAS: 1.5, pROAS: 1.6
  Incremental Revenue = 1.5 * $80,000 = $120,000
...
Display:
  iROAS: 0.5, pROAS: 2.0
  Incremental Revenue = 0.5 * $20,000 = $10,000
```

This analysis shows that while display advertising appeared to perform well in platform reporting, it actually had a negative ROI when considering incrementality. Conversely, email marketing, which seemed to perform moderately in direct attribution, actually drove the highest incremental revenue.
...
Network A:
  iROAS: 0.8, pROAS: 2.5
  Incremental Revenue = 0.8 * $50,000 = $40,000

Network B:
  iROAS: 1.2, pROAS: 2.0
  Incremental Revenue = 1.2 * $40,000 = $48,000

Network C:
  iROAS: 1.5, pROAS: 1.7
  Incremental Revenue = 1.5 * $25,000 = $37,500
```
