...
Next we will dive into each of these pillars of Lifesight's MMM framework, starting with the why and the how of the [Causal Reasoning in Modeling](https://docs.lifesight.io/docs/structural-causal-modeling#/)
