...
next:
  description: ''
---
**Granular Models**<br />Granular models are created for the purpose of generating granular MMM insights - at campaign or sub campaign levels. Example : Incrementality at specific TV Channels / Shows Level.  Incrementality at various KOL Influencer level, etc...
