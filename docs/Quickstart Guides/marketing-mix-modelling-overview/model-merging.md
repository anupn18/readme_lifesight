...
metadata:
  title: Merging Model
  keywords:
    - Lifesight model merging
  robots: noindex
---
Most teams run more than one model, usually one per region, brand, or business unit. That is the right way to build them, but it makes portfolio-level questions awkward: you have to open each model separately and reconcile the numbers by hand.

Merge does that consolidation for you, so you can review performance across models in a single view. The source models stay as they are, so you keep the detail when you need it.

## Select compatible models

1. Open **Model List** and click on **Merge Models** on top right.

![](https://files.readme.io/36d969424379609cfc05cff6b74b6184b16f8730c0cf1200f0f4d20f8154b3e3-Screenshot_2026-09-11_at_12.14.08_PM.png)
...
![](https://files.readme.io/674c8c4aa6188ff609b0990b8f4deaac6d0727f33a1e73669e8c0d1f6f739d79-Screenshot_2026-09-11_at_12.15.04_PM.png)
