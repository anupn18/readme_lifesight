...
next:
  description: ''
---
**Connect** is the foundational component of our platform, designed to streamline the integration, ingestion, aggregation, transformation and operationalization of data from diverse sources. By centralizing your marketing, business, and customer data, Connect eliminates data silos, enhances data accuracy, and ensures that your marketing teams have access to comprehensive, real-time insights. This module supports a wide array of data source and destination integrations, enabling marketers to make informed, data-driven decisions that drive profitability and sustainable growth.

Lifesight unifies fragmented data across marketing and sales channels, creating a single source of truth that enables the seamless operationalization for use in analytics, modeling and experiments, which then powers insights for better decision-making. This guide walks you through integrating, managing, and operationalizing your data for maximum impact.

## Supported Data Source/Destination Integrations
...
## Unify and activate your customer data seamlessly

The ability to centralize and organize customer data is critical for gaining insights and driving personalized marketing efforts. Learn how you can unify customer data through Segments, Profiles, and Consent management.
