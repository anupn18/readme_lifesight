...
Geo splits (DMA/State/Region), price & promo calendar, high‑level creative/audience tags, retail/POS rollups
...
Pass criteria: If all checks pass, you’re ready for your first Measure read.
