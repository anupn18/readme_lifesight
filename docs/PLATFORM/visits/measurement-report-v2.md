...
`https://pixel.ad.lifesight.io/pixel/event/xxxxxx?event=RENDER&ios_idfa=[ios_idfa]&android_gaid=[android_gaid]&cid=[campaign_id]&app=[app_name]&channel=customdsp&cv=300x250&style=banner&dnt=[do_not_track]&cb=[cachebuster]&ts=[currentTime]`

* 728x90 Video Ad:

`https://pixel.ad.lifesight.io/pixel/event/xxxxxx?event=RENDER&ios_idfa=[ios_idfa]&android_gaid=[android_gaid]&cid=[campaign_id]&app=[app_name]&channel=customdsp&cv=728x90&style=video&dnt=[do_not_track]&cb=[cachebuster]&ts=[currentTime]`

* 160x600 Banner Ad:

`https://pixel.ad.lifesight.io/pixel/event/xxxxxx?event=RENDER&ios_idfa=[ios_idfa]&android_gaid=[android_gaid]&cid=[campaign_id]&app=[app_name]&channel=customdsp&cv=160x600&style=banner&dnt=[do_not_track]&cb=[cachebuster]&ts=[currentTime]`
...
2. Identifying Patterns:
   8-9AM : Brand ABC finds that ads shown in between 8-9AM lead to store visits predominantly on weekends, specifically on Saturdays. 3-4PM : Ads shown in between 3-4PM lead to store visits more frequently on weekdays, particularly on Tuesdays and Thursdays.
...
7-8PM Ads are best suited for Fridays and weekends, aligning with the time people are more likely to shop after work or on their days off.
...
1. The competitor store should be within the same city as your brand's store
2. The competitor store should be within 50km radius of your brand store.

* **Market Index** - Market Index serves as a benchmark, with competitor brands indexed at 100. Your brand's performance and that of selected competitors are compared against this index, providing a clear perspective on relative market performance. A high market index suggests strong market performance relative to competitors. Use this data to benchmark success and identify areas for competitive improvement.

* **Campaign Audience** - Campaign Audience compares visits to your store with visits to competitors' stores by users exposed to your ads. This comparison provides insights into your campaign's competitive effectiveness.
...
**3. Visit Lift Index Calculation:**

The Visit Lift Index is calculated as:
