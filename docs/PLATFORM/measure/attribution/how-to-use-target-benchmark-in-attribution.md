...
next:
  description: ''
---
Target Benchmarks are a powerful for marketers who want to optimize their marketing efforts to achieve them. Lifesight lets users input their marketing KPI goals and get automated recommendations at a granular level in the Channel breakdown table.

View powerful insights such as Scale-up, Maintain, Stop, and Reduce spends across platforms, tactics, campaigns, ad groups, and at an ad-level granularity.
