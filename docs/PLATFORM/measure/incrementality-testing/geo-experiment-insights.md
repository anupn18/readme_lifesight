...
![Screenshot of the Insights page showing key difference metrics](http://googleusercontent.com/file_content/2)
...
![Screenshot of the Test Design configuration](http://googleusercontent.com/file_content/1)

* **Hypothesis**: The original question you set out to answer (e.g., "Incremental Return of Meta by Holding Out").
* **Treatment Type**: The kind of test run (e.g., Hold-Out, Heavy-Up).
...
![Screenshot of the advanced charts on the Test Design page](http://googleusercontent.com/file_content/0)
