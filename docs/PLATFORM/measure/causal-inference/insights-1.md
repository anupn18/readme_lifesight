...
The "Reset" icon clears all applied filters to the default view.

![](https://files.readme.io/bd3088fcf849b4a00d42d18feab3508d1b8c2fe368d7b39d40dead5df9a443de-image.png)

<br />

## Causal Impact Matrix

This chart visually shows the Cause and Effect relation between variables by showing ATE for each relation. Hover over the ATE between variables to view the Confidence score percentage.
