...
* **Trend or No Trend:** If the points plotted on the scatter diagram show any trend either upward or downward, then it can be said that the variables are correlated. However, if the plotted points do not show any trend, then it can be said that the variables are not correlated.
