...
> 👍 Manual vs. Automatic Changes
>
> The logs capture both manual adjustments you make directly within the Optimizer and automated changes applied by the platform based on accepted recommendations. This ensures a complete audit trail of all optimization activities.
...
Each entry in the log provides specific details about a change. The logs are grouped by the date and time of execution.
