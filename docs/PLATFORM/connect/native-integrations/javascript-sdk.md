...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "eventName",
    "0-1": "The name of the tracked event. eg) page view, add to cart etc ",
    "1-0": "properties",
    "1-1": "The event-related properties.  \nNote: If you do not want to send the properties, pass an empty object ({}) instead."
  },
  "cols": 2,
  "rows": 2,
  "align": [
...
1. ## Step 1: Setting up the Custom JS SDK [Base Tag]
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/45a53ec99493dd323984441471b7b0b1ea76499a1539c36d88187313642040f1-Screenshot_2024-09-11_at_2.47.35_PM.png","",""],"align":"center"}]}[/block]
